...
df = pd.read_csv("py2/HeightWeight.csv")
...
#Median for weight and height
height_median = statistics.median(height_list)
weight_median = statistics.median(weight_list)

#Mode for weight and height
...
#1st, 2nd and 3rd Standard Deviations for weight
...
weight_list_of_data_within_1_std_deviation = [result for result in weight_list if result > weight_first_std_deviation_start and weight_first_std_deviation_end]
weight_list_of_data_within_2_std_deviation = [result for result in weight_list if result > weight_second_std_deviation_start and weight_second_std_deviation_end]
weight_list_of_data_within_3_std_deviation = [result for result in weight_list if result > weight_third_std_deviation_start and weight_third_std_deviation_end]

#Printing data for weight(Standard Deviation)
print(" {}% of data for weight lies within 1 standard deviations".format(len(weight_list_of_data_within_1_std_deviation)*100.0/len(weight_list)))
